...
Hooks[1] = hookmetamethod(mouse, "__index", newcclosure(function(self, index)
    if index == "Hit" and Psalms.Tech.Enabled and Psalms.Tech.LockType == "Index" and TargetPlr and TargetPlr.Character and Psalms.Tech.SelectedPart then
...
local Window = Library:Window({
    Name = 'Psalms.<font color="'..RealColor..'">Tech</font> | '..guh..' | '..dick,
    Amount = 4
})
