        ...
        if l_199.open then
            ...
            for l_206,l_207 in pairs(l_192)do
                local l_208=l_29("TextButton",{
                    ...
                    FontFace=l_28.font,
                    TextColor3=l_28.textcolor,
                    BackgroundColor3=l_207==l_199.current and l_28.accent or l_28.light_contrast,
                    BorderSizePixel=0,
